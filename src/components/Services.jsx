            ...
            {Carddata.map((data, index) => {
              return (
                <div className={`${data.width} flex`} key={index}>
                  <div className="bg-[#0E0D0D] !shadow-[0px,_0px,_0px,_1px_#F4F4F51A] rounded-[16px] relative hover:bg-gradientbg group hover:border-transparent transition-colors ease-linear duration-500 inline-block cursor-pointer py-[40px] px-[32px] ">
