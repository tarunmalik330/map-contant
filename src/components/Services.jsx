            ...
            {Carddata.map((data, index) => {
              return (
                <div className={`${data.width} flex`} key={index}>
                  <div className="bg_card rounded-[16px] relative hover:bg-gradientbg group hover:border-transparent transition-colors ease-linear duration-500 inline-block cursor-pointer py-[40px] px-[32px] ">
